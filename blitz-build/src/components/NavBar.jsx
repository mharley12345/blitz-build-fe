...
const NavLinkHover = (hoverIndex, index) => {
  if (hoverIndex === index) return HoverStyles;
};
      ...
      <NavScrollableContainer>
        <LogoAvatarContainer>
          ...
          <UserProfile>
            <UserImg>
              {" "}
              <img src={userInfo.picture} style={imgStyle} />
            </UserImg>
            <UserInfoContainer>
        ...
        <NavBarUl style={{ background }} className={navOpen ? "active" : ""}>
          {/* functionality for opening and closing the nav */}

          <NavBarFigure onClick={() => setNavOpen(!navOpen)}></NavBarFigure>
